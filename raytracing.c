...
{
    raydetail *detail = (raydetail *) ray;
    point3 u, v, w, d;
        ...
        for (int i = 0; i < detail->width; i++) {
            ...
            for (int s = 0; s < SAMPLES; s++) {
                ...
                rayConstruction(d, u, v, w,
                                ...
                                j * factor + s % factor,
                                detail->view,
                                detail->width * factor, detail->height * factor);
                if (ray_color(detail->view->vrp, 0.0, d, &stk, detail->rectangulars, detail->spheres,
                              detail->lights, object_color,
